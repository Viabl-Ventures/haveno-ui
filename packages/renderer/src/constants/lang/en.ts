...
const LangPackEN: { [key in LangKeys]: string } = {
  ...
  [LangKeys.MarketFilterAccountDescSignedAccounts]: "Only show accounts that have been signed. Please be aware that new accounts need to get the chance to get signed.",
  [LangKeys.MarketFilterAccountLabelMinAccountAge]: "Minimum account age",
  [LangKeys.MarketFilterAccountDescMinAccountAge]: "Only show trade offers with a minimum account age.",
  [LangKeys.MarketFilterAccountLabelAmountTrades]: "Minimum amount of trades",
  [LangKeys.MarketFilterAccountDescAmountTrades]: "Only show trade offers from accounts with a minimum amount of completed trades",
